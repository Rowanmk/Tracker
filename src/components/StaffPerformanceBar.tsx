...
export const StaffPerformanceBar: React.FC<Props> = ({ staffPerformance }) => {
  ...
  return (
    <div
      className="rounded-lg px-6 py-4 relative min-h-[56px]"
    ...
    >
      ...
      <div className="absolute left-4 top-1/2 -translate-y-1/2">
        <select
          ...
          className="px-3 py-2 rounded-md bg-white text-gray-900 text-sm border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
