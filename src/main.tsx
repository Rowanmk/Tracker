...
const renderFatal = (message: string) => {
  ...
  rootElement.innerHTML = `
    <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:#f9fafb;font-family:system-ui,sans-serif;padding:16px;">
      <div style="background:#fff;border:1px solid #e5e7eb;border-radius:16px;padding:32px;max-width:520px;width:100%;text-align:center;box-shadow:0 10px 25px rgba(0,0,0,0.08);">
        ...
        <p style="color:#4b5563;font-size:14px;margin:0 0 16px;">${message}</p>
